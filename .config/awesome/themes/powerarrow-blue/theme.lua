...
theme.taglist_font                              = "Droid Sans Bold 18"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, height = 33, bg = theme.bg_normal, fg = theme.fg_normal })
